...
function App() {
  ...
  const claimNFTs = (_amount) => {
    ...
    setFeedback("Minting your Opex Bots... How Exciting?");
    setClaimingNft(true);
    blockchain.smartContract.methods
      .mint(blockchain.account, _amount)
      .send({
        gasLimit: "285000",
        to: "0x396d05aDCc8479930Bfd507224c0ac2F6acd29ED",
      ...
      .then((receipt) => {
        setFeedback(
          "Congatulations on your Opex Bots! Welcome to the family."
        );
        setClaimingNft(false);
  ...
  return (
    <s.Screen style={{ backgroundColor: "#2b2b2b" }}>
      <s.Container flex={1} ai={"center"} style={{ padding: 24 }}>
        ...
        <ResponsiveWrapper flex={1} style={{ padding: 24 }}>
          ...
          <s.Container
            ...
            jc={"center"}
            ai={"center"}
            style={{ backgroundColor: "#5271ff", padding: 24 }}
          >
            {Number(data.totalSupply) === 10000 ? (
              <>
                ...
                <s.TextDescription style={{ textAlign: "center" }}>
                  You can still find Opex Bots on{" "}
                  <a
                    target={"_blank"}
                    href={""}
                  >
              ...
              <>
                <s.TextTitle style={{ textAlign: "center" }}>
                  1 OPXB costs .009 ether.
                </s.TextTitle>
                <s.SpacerXSmall />
                <s.TextDescription style={{ textAlign: "center" }}>
                  Excluding a small gas fee.
                </s.TextDescription>
                <s.SpacerSmall />
                <s.TextDescription style={{ textAlign: "center" }}>
                  {feedback}
